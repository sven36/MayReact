...
function renderRootComponent(vnode,props,context){
	...
	dom=document.createElement(nodeName);

	var childrens=renderChildrenComponent(renderedVnode);
	
	dom.appendChild(childrens);
	
	return dom;
  
}
function renderChildrenComponent(vnode){
