...
package contains a precompiled static library in release mode.
It has been compiled with Visual Studio 2010 using a static runtime library.
Additional configurations may work, but are untested.
